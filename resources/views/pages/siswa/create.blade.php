                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="kata_sandi" id="kata_sandi" class="form-control rounded-0 @error('kata_sandi') is-invalid @enderror" value="{{ old('kata_sandi') }}" required maxlength="30">
                                            @error('kata_sandi')
