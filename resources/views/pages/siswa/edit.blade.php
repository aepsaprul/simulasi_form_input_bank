...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="text-uppercase">Ubah Data Siswa</h5>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="form_edit" action="{{ route('siswa.update') }}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button class="btn btn-primary btn-sm btn-edit-spinner d-none btn-flat" disabled style="width: 130px;">
                                            <span class="spinner-grow spinner-grow-sm"></span>
                                            Loading...
                                        </button>
                                        <button type="submit" class="btn bg-gradient-primary btn-sm btn-edit-submit btn-flat" style="width: 130px;"><i class="fas fa-save"></i> Perbaharui</button>
                                    </div>
                                </div>
                            </form>
                        </div>
