...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="text-uppercase">data nasabah</h5>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <a href="{{ route('nasabah.create') }}" class="btn bg-gradient-primary btn-sm pl-3 pr-3 btn-flat">
                        ...
                        <div class="card-body">
                            <table id="nasabah_tabel" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
...
<div class="modal fade modal-delete" id="modal-default">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="form-delete" action="{{ route('nasabah.delete') }}" method="post">
                @csrf
